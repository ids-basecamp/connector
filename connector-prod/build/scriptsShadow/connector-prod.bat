...
set CLASSPATH=%APP_HOME%\lib\clearing-house-edc.jar

@rem Execute connector-prod
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONNECTOR_PROD_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CONNECTOR_PROD_EXIT_CONSOLE%" exit 1
exit /b 1
